...
from gnn.metalayer import MetaLayer,MLP,DropoutIfTraining,MLPwoLastAct
...
class IGNN(nn.Module):
    ...
    def attr_init(self,conforms):
        ...
        return node_attr.to(self.device),edge_attr.to(self.device),global_attr.to(self.device),edge_index.to(self.device)